...
<p align="center">Bhailang supports simple if else construct , <code>agar boss</code> block will execute if condition is <code>sahi</code> and <code>warna boss</code> block will execute if condition is <code>galat</code>.</p>
